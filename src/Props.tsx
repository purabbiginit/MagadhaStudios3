...
const characters = [
  { id: 1, name: "Realistic 3D", img: "/characters/prop1.jpg", glow: "from-[#FF5F6D] to-[#FFC371]" },
  { id: 2, name: "Mythic 3D", img: "/characters/prop2.jpg", glow: "from-[#00C9FF] to-[#92FE9D]" },
  { id: 3, name: "Heroic 3D", img: "/characters/prop3.jpg", glow: "from-[#7F00FF] to-[#E100FF]" },
  { id: 4, name: "Epic 3D", img: "/characters/prop4.jpg", glow: "from-[#FF512F] to-[#F09819]" },
  { id: 5, name: "Legend 3D", img: "/characters/prop5.jpg", glow: "from-[#36D1DC] to-[#5B86E5]" },
  { id: 6, name: "Ancient 3D", img: "/characters/prop6.jpg", glow: "from-[#FF9966] to-[#FF5E62]" },
  { id: 7, name: "Divine 3D", img: "/characters/prop7.jpg", glow: "from-[#00B09B] to-[#96C93D]" },
  { id: 8, name: "Fantasy 3D", img: "/characters/prop8.jpg", glow: "from-[#ED213A] to-[#93291E]" },
  { id: 9, name: "Mystic 3D", img: "/characters/prop9.jpg", glow: "from-[#2AF598] to-[#009EFD]" },
  { id: 10, name: "Celestial 3D", img: "/characters/prop10.jpg", glow: "from-[#F7971E] to-[#FFD200]" },
];
